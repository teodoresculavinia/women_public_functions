...
saveRDS(comm_year, file = "shiny-app/data/comm_year.rds")

comm_year <- comm_year %>%
  mutate(communist = ifelse(year_first <= 1980 & 1980 <= year_last, "yes", "no"))
